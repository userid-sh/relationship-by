...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOMAINPROPERTY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOMAINPROPERTY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOMAINPROPERTY actions', async () => {
      const arg = { id: 11381 };
    ...
    it('dispatches UPDATE_DOMAINPROPERTY actions', async () => {
      const arg = { id: 11381 };
    ...
    it('dispatches PARTIAL_UPDATE_DOMAINPROPERTY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOMAINPROPERTY actions', async () => {
      const arg = 42666;
