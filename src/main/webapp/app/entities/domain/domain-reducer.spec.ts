...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './domain.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOMAIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOMAIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOMAIN actions', async () => {
      const arg = { id: 12197 };
    ...
    it('dispatches UPDATE_DOMAIN actions', async () => {
      const arg = { id: 12197 };
    ...
    it('dispatches PARTIAL_UPDATE_DOMAIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOMAIN actions', async () => {
      const arg = 42666;
