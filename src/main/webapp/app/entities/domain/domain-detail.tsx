    ...
    <Row>
      <Col md="8">
        <h2 data-cy="domainDetailsHeading">
          <Translate contentKey="jhipsterApp.domain.detail.title">Domain</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="jhipsterApp.domain.name">Name</Translate>
            </span>
          </dt>
          <dd>{domainEntity.name}</dd>
        </dl>
