...
import { deleteEntity, getEntity } from './domain.reducer';
...
export const DomainDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/domain${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterApp.domain.delete.question">
        <Translate contentKey="jhipsterApp.domain.delete.question" interpolate={{ id: domainEntity.id }}>
