...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPROPERTY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERPROPERTY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERPROPERTY actions', async () => {
      const arg = { id: 27208 };
    ...
    it('dispatches UPDATE_USERPROPERTY actions', async () => {
      const arg = { id: 27208 };
    ...
    it('dispatches PARTIAL_UPDATE_USERPROPERTY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERPROPERTY actions', async () => {
      const arg = 42666;
